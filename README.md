...
> For ease of programming, this project uses a simplified variant of the complete
> Pathery rules. Specifically, it lacks support for duplicate checkpoints (including
> start and finish), and any special tile aside from checkpoints and teleports.
